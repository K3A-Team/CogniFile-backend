...
class User:
    ...
    def __init__(self, firstName: str, lastName: str, email: str, password: str, rootFolderId :str, chatbotSessionId : str, usedSpace: str = "0B", trial: str = 'free', id : str = None, subscriptionID : str = None, trashFolderId : str = None, oauth = None): 
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "trial" : self.trial, #can be free, basic, standard, premium or entreprise!
