...
class User:
    ...
    """
    def __init__(self, firstName: str, lastName: str, email: str, password: str, rootFolderId :str, chatbotSessionId : str, usedSpace: str = "0B", trial: str = 'basic', id : str = None , trashFolderId : str = None): 
